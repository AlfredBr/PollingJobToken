...
public class WeatherForecastJobProcessor : IJobProcessor<WeatherForecastRequest, WeatherForecastResponse>
{
    public Task<WeatherForecastResponse> RunAsync(WeatherForecastRequest request, CancellationToken cancellationToken)
    {
